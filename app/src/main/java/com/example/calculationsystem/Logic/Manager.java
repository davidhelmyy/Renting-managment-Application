 ...
 public static List<String> getNames(boolean isOwner,boolean isPayment)
 {
    ...
    public static List<String> getFinalReports(boolean isOwner)
    {
        ...
        if(isOwner){
            ...
            for(int i=0;i<owners.size();++i)
            {
                String temp=owners.get(i).getName()+"\nMoney required: "+owners.get(i).getRequiredMoney()
                        +"\nMoney paid: "+owners.get(i).getReceviedMoney()+"\nMoney left: "+owners.get(i).getMoneyLeft();
                list.add(temp);
            }
        ...
        else
        {
            for(int i=0;i<renters.size();++i)
            {
                String temp=renters.get(i).getName()+"\nMoney required: "+renters.get(i).getRequiredMoney()
                        +"\nMoney paid: "+renters.get(i).getReceviedMoney()+"\nMoney left: "+renters.get(i).getMoneyLeft();
                list.add(temp);
            }
        }
