    ...
    private void load() {
      ...
      ArrayAdapter<String>  adapterL=new ArrayAdapter<>(this,android.R.layout.simple_list_item_1
        ...
        listLands.setAdapter(adapterL);
               ...
               req.setText("Required: "+String.valueOf(Manager.getMoneyRequiredForCust(index,isOwner)));
        paid.setText("Paid: "+String.valueOf(Manager.getMoneyInForCustomers(index,isOwner)));
        left.setText("Left: "+String.valueOf(Manager.getMoneyleftForCustomers(index,isOwner)));
